...
1. Klicken Sie auf der Homepage auf **[!UICONTROL Wissensquellen]**.

1. Benennen Sie die Wissensquelle.

1. Klicken Sie **[!UICONTROL Hinzufügen]**, um eine CSV-Datei hochzuladen.

   Stellen Sie sicher, dass er eine Spalte für Website-URLs enthält.

1. Warten Sie einige Augenblicke für die Verarbeitung.

   Dieser Schritt wird ziemlich schnell aufgelöst, da der Status in Echtzeit aktualisiert wird.

1. Kehren Sie nach dem Hinzufügen zur Homepage zurück.
...
1. Navigieren Sie nach der Einrichtung zurück zur Homepage und klicken Sie auf **[!UICONTROL Vorschau]**.
1. Verwenden Sie die Chat-Oberfläche, um Ihre Abfrage einzugeben (z. B. _Empfehlen Sie einen Laptop unter $1000_).
1. Concierge-Antworten prüfen.
1. Verwenden Sie das rechte Bedienfeld, um Ihre Einstellungen für Markenausdrücke anzupassen.
1. Klicken Sie **[!UICONTROL Freigeben]**, um einen Link für Team-Feedback zu generieren.
...
1. Klicken Sie in der Vorschau auf **[!UICONTROL Testeransicht]**.
1. Verwenden Sie die Tester-Ansicht, um Konversationen mit Endbenutzern zu simulieren.
1. Verwenden Sie den „Daumen hoch“- und „Daumen runter“-Mechanismus, um jede erhaltene Antwort zu bewerten.
1. Füllen Sie das Feedback-Formular für die Daumen nach unten aus:
...
1. Hinzufügen von Kommentaren und spezifischen Anmerkungen.
1. Feedback zur Überprüfung des Dashboards einreichen.
...
1. Verwenden Sie den bereitgestellten Schnappschuss, um Informationen zu allgemeinen Trends anzuzeigen.
1. Um auf einen tiefen Einblick in Customer Journey Analytics zuzugreifen, wählen Sie **[!UICONTROL Bericht anzeigen]**.
